...
const initialState = store.getState() // pegando  valor inicial, ou seja, null

describe('zustand store', () => {
    beforeEach(() => {
        store.setState(initialState)
    
    }) // a cade teste ele vai reiniciar o estado do store, para que um teste não intereja com outro
